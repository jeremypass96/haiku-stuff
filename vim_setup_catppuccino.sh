...
echo -e "${BLUE}Setting up Vim with the Catppuccino Mocha colorscheme and Lightline plugin...${NC}"
...
echo -e "${MAGENTA}Vim setup completed with Catppuccino Mocha colorscheme and Lightline plugin.${NC}"